...
class TreeSetTests(unittest.TestCase):
    ...
    def test_arc_weight(self):
        ...
        self.assertAlmostEqual(float("inf"), g.arc_weight(1, 0))
        self.assertAlmostEqual(float("inf"), g.arc_weight(1, 4))
    ...
    def test_path_weight(self):
        ...
        self.assertAlmostEqual(float("inf"), g.path_weight([3, 2, 0]))
